...
export class LoginPure extends React.PureComponent {
	constructor(props) {
		super(props);
		this.state = {
			name: "",
	...
	login = async () => {
		this.props.login(this.state.email, this.state.name, this.props.userId);
		...
		return (
			<KeyboardAvoidingView style={styles.container} behavior="height">
				...
				<View style={styles.imageContainer}>
					...
					/>
					<Text style={styles.title}>Login To City Feed</Text>
				</View>
